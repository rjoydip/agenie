...
- use_tools: Task needs to fetch data using tools
 ...
 */
export const TOOL_SELECTION_SYSTEM_PROMPT = `Select and call tools to complete the task. Use the provided parameters.
